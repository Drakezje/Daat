...
// const sum = numbers.reduce((total, currentaValue) => {
//    return total + currentaValue}
// ,0);
// console.log(sum);

// var totalcoin = courses.reduce((total,current)=> total + current.coin,0)
// console.log(totalcoin);

// const squaredNumbers = numbers.map(number => number * number);
// console.log(squaredNumbers);

// const printmess = (message) => console.log(message)
// printmess("Xin chao")
...
//bài tập làm phẳng mảng = depth array
const depthArray = [1, 2, [3, 4], 5, 6, [7, 8, 9]];

// const flatArray = depthArray.reduce((flatoutput,depthitem)=>
//     flatoutput.concat(depthitem),[])
// console.log(flatArray);


//làm phẳng với foreach
...
// const flatArray = depthArray.reduce((acc,value)=>{
...
// var myKey = "address"
//cach them key moi
// myinfor.key = "chia khoa";
// myinfor["my-email"] = "shyndeptrai01@gmail.com" // thêm ký tự đặt biệt

//console.log(myinfor[myKey]); cách tìm 1 key thông qua biến = HN
...
//object contrusctor:
//là 1 bản thiết kế, là cái khung
// quy ước chung, viết hoa chữ cái đầu tiên object contrusctor
//không phải đối tượng, chỉ là mô tả thiết kế đối tượng
//có thể thêm thuộc tính riêng,phương thức riêng khi tạo object contrusctor

const User= function (firstName, lastName, avatar) {
    this.firstName = firstName;
    this.lastName = lastName;
    this.avatar = avatar;
    //this này mô tả những thuộc tính, phương thức sẽ có cho đối tượng khi khởi tạo từ
   
    this.getName = function() {

    return `${this.firstName} ${this.lastName}`;
    //this này là author.firstName()
    }
    }
var author = new User('do', 'thanh', 'dat');
author.title = 'Tạo thêm 1 thuộc tính mới'
console.log(author);
